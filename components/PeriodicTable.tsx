        ...
        return (
          <div className="animate-fade-in text-[var(--text-secondary)]">
            ...
            <ul className="text-xs space-y-1">
              <li><strong>Electron Config:</strong> <ContentRenderer content={activeInsight.electronConfiguration} inline /></li>
        ...
        <div className="flex flex-col h-full">
            ...
            <div className="flex flex-col md:flex-row gap-4 flex-grow relative overflow-hidden">
                <div className="flex-grow w-full flex flex-col overflow-hidden">
                    ...
                    {/* Zoom Viewport */}
                    <div className="flex-grow w-full overflow-auto custom-scrollbar">
                        <div 
                ...
                <aside className={`
                    ...
                    {/* --- DISPLAY AREA --- */}
                    <div className="flex-grow overflow-y-auto pr-2 border-t border-[var(--border-primary)] pt-4 custom-scrollbar">
                            ...
                            <div className="mt-4 pt-4 border-t border-[var(--border-primary)] animate-fade-in">
                                ...
                                {reaction.reactionPossible ? (
                                    <>
                                        ...
                                        <p className="text-sm text-[var(--text-secondary)]"><ContentRenderer content={reaction.explanation} inline /></p>
                                    </>
                                ) : (
