            ...
            <div className="flex flex-col h-full animate-fade-in">
                <div className="flex-shrink-0 mb-4">
                    ...
                    <div className="bg-[var(--bg-secondary)] p-4 rounded-lg">
                        ...
                        <div className="text-[var(--text-primary)]"><ContentRenderer content={selectedProblem.problemStatement} inline /></div>
                    </div>
                </div>
                        ...
                        <div>
                            ...
                            <div className="prose prose-invert max-w-none text-justify">
                                ...
                                <div className="mt-4 p-3 bg-[var(--bg-success)] border border-[var(--border-success)] rounded-lg not-prose">
                                    ...
                                    <span className="font-mono"><ContentRenderer content={solutions[activeSolutionTab].finalAnswer} inline /></span>
                                </div>
                            </div>
                        </div>
                    )}
            ...
            <div className="flex-grow overflow-y-auto pr-2 space-y-4 custom-scrollbar">
                {problems.length > 0 ? problems.map((problem, index) => (
                    <button 
                        ...
                        className="w-full text-left p-4 rounded-lg bg-[var(--bg-secondary)] hover:bg-[var(--bg-tertiary)] transition-colors"
                    >
                        <div className="flex items-start">
                            ...
                            <div className="flex-1">
                                ...
                                <div><ContentRenderer content={problem.problemStatement} inline /></div>
                            </div>
                        </div>
                    </button>
                )) : (
