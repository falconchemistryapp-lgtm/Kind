...
const ChatBox = ({
    ...
    return (
        <>
            ...
            {/* Chat Window */}
            <div className={`fixed bottom-4 right-4 z-50 w-[calc(100%-2rem)] max-w-md h-[70vh] max-h-[500px] bg-[var(--bg-secondary)] rounded-xl shadow-2xl flex flex-col transition-all duration-300 ease-in-out ${isOpen ? 'translate-y-0 opacity-100' : 'translate-y-16 opacity-0 pointer-events-none'}`}>
                {/* Header */}
